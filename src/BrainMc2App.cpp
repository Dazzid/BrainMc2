...
public:
    ...
    //ImageTexture
    gl::Texture		frontalImage;
    gl::Texture		lateralImage;
    gl::Texture		cenitalImage;
    gl::Texture		frontalImage_2;
    gl::Texture		lateralImage_2;
    gl::Texture		cenitalImage_2;
...
//---------------------------------------------------------------------------------------------------------------
void BrainMc2App::cleanAllAreas(){
...
void BrainMc2App::setup()
{
    ...
    frontalImage = loadImage( loadAsset( "1_f.png" ) );
    lateralImage = loadImage( loadAsset( "1_l.png" ) );
    cenitalImage = loadImage( loadAsset( "1_c.png" ) );
    frontalImage_2 = loadImage( loadAsset( "n_f.png" ) );
    lateralImage_2 = loadImage( loadAsset( "n_l.png" ) );
    cenitalImage_2 = loadImage( loadAsset( "n_c.png" ) );
...
void BrainMc2App::keyDown( KeyEvent event )
{
    ...
    switch( event.getCode() ){
        ...
        case KeyEvent::KEY_c:       setConnections(); drawAllConnections = true;                                                     break;
        ...
        case KeyEvent::KEY_9:
            ...
            show_2 = true;
            level = 5;
            filterRegion("Brodmann area 10", 5);
            break;
...
void BrainMc2App::draw()
{
    ...
    if(show_1){
        ...
        gl::translate( 62,67,-55);
        gl::scale( Vec3f( -0.25, -0.25, 0.0 ) );
        gl::draw( frontalImage, Vec2f( 0, 0 ) );
        gl::popModelView();
        
        gl::pushModelView();
        gl::color( ColorA( 1.0f, 1.0f, 1.0f, 0.5f) );
        gl::rotate(Vec3f(0,90,0));
        gl::scale( Vec3f( 0.282, -0.282, 0.0 ) );
        gl::translate( -450, -375,0);
        gl::draw( lateralImage, Vec2f( 0, 0 ) );
        gl::popModelView();
    }
    ...
    if(show_2){
        gl::pushModelView();
        gl::color( ColorA( 1.0f, 1.0f, 1.0f, 0.5f) );
        gl::translate( 62,67,-60);
        gl::scale( Vec3f( -0.25, -0.25, 0.0 ) );
        gl::draw( frontalImage_2, Vec2f( 0, 0 ) );
        gl::popModelView();
        ...
        gl::scale( Vec3f( 0.282, -0.282, 0.0 ) );
        gl::translate( -450, -375, 0);
        gl::draw( lateralImage_2, Vec2f( 0, 0 ) );
        gl::popModelView();
    }
    
    //    gl::pushModelView();
    //    gl::color( ColorA( 1.0f, 0.5f, 0.0f, 0.5f) );
    //    gl::drawSphere(Vec3f(0, 5, -54), 4.0);
    //    gl::popModelView();
    //
    //    gl::pushModelView();
    //    gl::color( ColorA( 1.0f, 0.5f, 0.0f, 0.5f) );
    //    gl::drawSphere(Vec3f(0, 40, 43), 3.0);
    //    gl::popModelView();
